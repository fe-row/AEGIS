...
export default function AuditPage() {
  ...
  const fetchLogs = async () => {
    setLoading(true);
    try {
      const params: any = { hours: filters.hours, limit: filters.limit };
      ...
      <main className="flex-1 p-8 overflow-y-auto">
        ...
        <div className="flex items-center gap-4 mb-6">
          ...
          <button onClick={fetchLogs}
            className="bg-aegis-600 hover:bg-aegis-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition">
            Apply
          </button>
        </div>
