...
import { Plus, X, CheckCircle, XCircle, Clock, Shield } from "lucide-react";
...
export default function PoliciesPage() {
  ...
  const fetchPermissions = async (agentId: string) => {
  ...
  useEffect(() => { fetchData(); }, []);
  useEffect(() => { fetchPermissions(selectedAgent); }, [selectedAgent]);
